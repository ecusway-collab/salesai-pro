...
async def voice_answer(request: Request, lead_id: int, db: Session = Depends(get_db)):
    ...
    try:
        ...
        r = VoiceResponse()
        r.say(f"Hi, this is Alex from Vital Health Global. We offer premium natural health products that can help with energy, wellness and vitality. Please visit getfreeproducts.net to learn more. Have a wonderful day!", voice="alice")
        r.hangup()
